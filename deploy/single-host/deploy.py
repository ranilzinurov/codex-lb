...
class DeploymentConfig:
    ...
    def from_file(cls, path: Path) -> DeploymentConfig:
        ...
        compose_file = resolve(value("DEPLOY_COMPOSE_FILE", str(REPOSITORY_ROOT / "docker-compose.prod.yml")))
...
"""
        result = self._run_command(
            [
                ...
                "python",
                "--mount",
                f"type=volume,src={self.config.data_volume},dst=/var/lib/codex-lb,readonly",
                "--mount",
