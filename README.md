...
образ при неудачном запуске. Не запускайте `deploy/single-host/docker-compose.yml` напрямую:
...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center" valign="top" width="14.28%"><a href="https://github.com/ranilzinurov"><img src="https://avatars.githubusercontent.com/u/79156479?v=4?s=100" width="100px;" alt="Ranil Zinurov"/><br /><sub><b>Ranil Zinurov</b></sub></a><br /><a href="https://github.com/ranilzinurov/codex-lb/commits?author=ranilzinurov" title="Code">💻</a> <a href="https://github.com/ranilzinurov/codex-lb/commits?author=ranilzinurov" title="Tests">⚠️</a> <a href="https://github.com/ranilzinurov/codex-lb/commits?author=ranilzinurov" title="Documentation">📖</a> <a href="#infra-ranilzinurov" title="Infrastructure">🚇</a></td>
    </tr>
  </tbody>
</table>
