...
export const overview = createDashboardOverview({
  ...
  apiKeyAttribution: {
    primary: {
      windowKey: "primary" as const,
      windowMinutes: 300,
      totalEstimatedUsedCredits: 0,
      entries: [],
    },
    secondary: {
      windowKey: "secondary" as const,
      windowMinutes: 10_080,
      totalEstimatedUsedCredits: 34_650,
      entries: [
        {
          bucket: "api_key" as const,
          accountId: "acc_01",
          accountEmail: "alex.research@fastlab.io",
          accountDisplayLabel: "alex.research@fastlab.io",
          apiKeyId: "key_prod",
          apiKeyName: "Production",
          keyPrefix: "sk-prod",
          requestCount: 12_420,
          totalTokens: 1_210_000_000,
          cachedInputTokens: 1_150_000_000,
          totalCostUsd: 312.44,
          estimatedCredits: 22_310,
          attributionSharePercent: 64.4,
          isAttributionEstimated: true,
        },
        {
          bucket: "api_key" as const,
          accountId: "acc_02",
          accountEmail: "dev.james@gmail.com",
          accountDisplayLabel: "dev.james@gmail.com",
          apiKeyId: "key_ci",
          apiKeyName: "CI Load",
          keyPrefix: "sk-ci",
          requestCount: 4_180,
          totalTokens: 412_000_000,
          cachedInputTokens: 388_000_000,
          totalCostUsd: 86.72,
          estimatedCredits: 7_420,
          attributionSharePercent: 21.4,
          isAttributionEstimated: true,
        },
        {
          bucket: "unattributed" as const,
          accountId: "acc_01",
          accountEmail: "alex.research@fastlab.io",
          accountDisplayLabel: "alex.research@fastlab.io",
          apiKeyId: null,
          ...
          keyPrefix: null,
          requestCount: 2_130,
          totalTokens: 296_000_000,
          cachedInputTokens: 282_000_000,
          totalCostUsd: 87.56,
          estimatedCredits: 4_920,
          attributionSharePercent: 14.2,
          isAttributionEstimated: true,
        },
      ],
    },
